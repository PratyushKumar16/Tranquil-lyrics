...
export default async function ApplyDynamicBackground(element: HTMLElement, tag?: string) {
  ...
  if (Defaults.StaticBackground) {
    if (Defaults.StaticBackgroundType === "Color") {
      ...
      let dynamicBg = element.querySelector<HTMLElement>(".tranquil-dynamic-bg.ColorBackground");
      if (!dynamicBg) {
        dynamicBg = document.createElement("div");
        dynamicBg.classList.add("tranquil-dynamic-bg", "ColorBackground");
    ...
    const prevBg = element.querySelector<HTMLElement>(".tranquil-dynamic-bg.StaticBackground");
    ...
    dynamicBg.classList.add("tranquil-dynamic-bg", "StaticBackground", "Hidden");
    ...
    const existingElement = element.querySelector<HTMLElement>(".tranquil-dynamic-bg");
    ...
    canvas.classList.add("tranquil-dynamic-bg");
...
const getColorBackgroundElement = (): HTMLElement | null => {
  ...
  const el = PageContainer?.querySelector<HTMLElement>(".tranquil-dynamic-bg.ColorBackground") ?? null;
...
// Throttle audio-analysis speed updates to at most every 500ms.
