...
const Fonts = DeepFreeze({
  Lyrics: () => LoadFont("https://fonts.spikerko.org/tranquil-lyrics/source.css"),
...
//     throw new Error('TranquilLyrics: ApplyStyles: Element or Properties Missing');
//   }
...
export const ApplyFontPixel = (): HTMLSpanElement | undefined => {
  ...
  fontPixel.classList.add("TranquilLyricsFontPixel");
