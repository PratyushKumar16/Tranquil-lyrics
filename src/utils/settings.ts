...
function devSettings(SettingsSection: any) {
  const settings = new SettingsSection(
    "Tranquil Lyrics - Developer Settings",
    "tranquil-lyrics-dev-settings"
  );
...
function generalSettings(SettingsSection: any) {
  const settings = new SettingsSection("Tranquil Lyrics", "tranquil-lyrics-settings");
  ...
  settings.addToggle("skip-tranquil-font", "Skip Tranquil Font*", Defaults.SkipTranquilFont, () => {
    storage.set("skip-tranquil-font", settings.getFieldValue("skip-tranquil-font") as string);
  });
  ...
  settings.addDropDown(
    ...
    ["Tranquil Lyrics (Default) (Stable)", "AML Lyrics (Experimental) (Unstable)"],
    Defaults.LyricsRenderer_Default,
    () => {
      const value = settings.getFieldValue("lyrics-renderer") as string;
      const processedValue =
        value === "Tranquil Lyrics (Default) (Stable)"
          ? "Tranquil"
...
/* function infos(SettingsSection: any) {
  const settings = new SettingsSection("Tranquil Lyrics - Info", "tranquil-lyrics-settings-info");
